  ...
  return (
    <div className='lg:w-2/3'>
      ...
      <div className='flex justify-between mb-10 mt-5'>
        <form onSubmit={buscarVet}>
          <div className="flex">
            ...
            className="text-center block rounded-md w-72 border-0 py-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            {...register('rutVet', {required : true})}/> 
            <button className='bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-sm px-6 
        ...
        <button className='flex bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-sm px-6 
      ...
      <div className='flex justify-center mb-5'>
        <p className='text-3xl text-black font-bold'>{veterinaria.nombreveterinaria}</p>
      </div>
      
      <div className='min-w-72 max-h-3/4 overflow-y-auto'>
