...
from .views import VeterinariaView, FranquiciaView, InsumosView, FechasCalendarioView, TablaMedicaView, RegistroDeOperacionesView, RegistroVacunasSuministradasView
